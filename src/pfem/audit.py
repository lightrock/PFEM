...
KNOWN_EVENT_KINDS = {
    ...
    "intake_decision_recorded", "import_recorded", "conflict_recorded", "merge_decision_recorded", "apply_receipt_recorded", "state_checkpoint_recorded", "state_transition_recorded", "snapshot_manifest_recorded", "snapshot_verification_recorded", "recovery_point_recorded", "restore_plan_recorded", "restore_approval_recorded", "restore_receipt_recorded", "restore_verification_recorded", "restore_closeout_recorded", "disposition_recorded", "disposition_receipt_recorded", "custody_recorded",
